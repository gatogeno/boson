...
def thermaltest(fieldparameters,fieldnc,unigrid):
    fieldnc[0]=np.random.uniform(np.amin(unigrid)/32.0,np.amax(unigrid)/32.0,size=(fieldparameters[2][0],3)).astype(cts.FTYPE)
